...
# Hide Solution & Discussion
    ...
    # A string is balanced if for each left parenthesis we have a matching right parenthesis.

    # # We can keep track of this by keeping a tally of the total parentheses count. 
    # Left parentheses are +1 and right parentheses are -1. If our string is balanced, 
    # then the total, parens will always be zero after parsing string.
    ...
    # # Here is an example: balanced?(')Hey!('). If we should ever have a negative value for parens, 
    # then we know that our left and right parentheses are reversed, and that this isn't a balanced string.
